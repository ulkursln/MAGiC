...
namespace MAGiC
{
    public static class Info
    {
        ...
        public static string LINK_AVI_FILE = "www.youtube.com";
        public static string LINK_WAV_FILE = "www.google.com";
        public static string LINK_SEGMENT_AUDIO = "";
        public static string LINK_SEGMENT_INTERVAL = "";
        public static string LINK_EXP_INTERVAL = "";
        public static string LINK_RESEGMENTED_INTERVAL = "";
        public static string LINK_RESEGMENTED_AUDIO = "";
        public static string LINK_SPEECH_ACTS = "";
        public static string LINK_SPEECH_ANNOTATION = "";
        public static string LINK_2DLANDMARK = "";
        public static string LINK_IMAGESIZEFILE = "";
        public static string LINK_ESTIMATED_POSE = "";
        public static string LINK_ACTION_UNITS = "";
        public static string LINK_3DLANDMARK = "";
        public static string LINK_EXPORTEDFRAME = "";
        public static string LINK_TEST_XML = "";
        public static string LINK_TRAINING_XML = "";
        public static string LINK_FACE_DETECTOR = "";
        public static string LINK_RAW_GAZEDATA = "";
        public static string LINK_FILLED_RAW_GAZEDATA = "";
        public static string LINK_AOI_FILE = "";
        public static string LINK_MANUALLY_LABELLED_AOI = "";
        public static string LINK_REANALYZE_AOI_OUTPUT = "";
        public static string LINK_SUMMARY_FILE = "";
    }
}
