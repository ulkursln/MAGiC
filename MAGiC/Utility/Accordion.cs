...
public class Accordion : UserControl, IMessageFilter {
	...
	public CheckBox Add(Control c, String text, String toolTip = null, double fillWt = 0, bool? open = null, Padding? contentPadding = null, Padding? contentMargin = null, Color? contentBackColor = null, Padding? checkboxMargin = null, bool? addResizeBar = null, Padding? resizeBarMargin = null, LayoutArgs layoutArgs = null, Size ? minSize =null) {
	...
	public CheckBox Add(AddArgs args) {
		...
		Control2 c2 = new Control2(cb, c, resizeBar, fillWt, layoutArgs, args.minSize);
	...
	private class Control2 : UserControl {
		...
		public Control2(CheckBox cb, Control c, Control resizeBar, double fillWt, LayoutArgs layoutArgs, Size? minSize) {
			this.cb = cb;
			this.c = c;
			this.fillWt = fillWt;
